 ...
 * Liste de champs SQL.
 *
 * @see net.codjo.imports.common.SQLField
 */
class SQLFieldList {
     ...
     */
    SQLFieldList(String dbTableName, Connection con)
          throws SQLException {
    ...
    /**
     * Construction d'une liste de champs a partir de la definition de la table pour un catalogue donné.
     *
     * @param dbTableName Le nom physique de la table.
     * @param con         La connection.
     ...
     * @throws SQLException Erreur d'access a la base.
     */
    SQLFieldList(String dbTableName, Connection con, String catalog)
          throws SQLException {
     ...
     *
     * @param dbFieldName nom physique du champs
     * @param value       La nouvelle valeur du champs.
     */
    public void setFieldValue(String dbFieldName, Object value) {
        getField(dbFieldName).setValue(value);
    }


    /**
     * Sets the FieldValue attribute of the SQLFieldList object (for Date value). Converts a java.util.Date
     * into java.sql.Date .
     *
     * @param dbFieldName nom physique du champs
     * @param value       La nouvelle date du champs.
     */
    public void setFieldValue(String dbFieldName, java.util.Date value) {
        getField(dbFieldName).setValue(value);
    }
    ...
    public String toString() {
        StringBuilder buffer = new StringBuilder("SQLFieldList(");
